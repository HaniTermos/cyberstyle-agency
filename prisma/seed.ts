import { PrismaClient, UserRole, UserStatus, LeadStage, ProjectStatus, MilestoneStatus, InvoiceStatus, ReviewStatus, PostStatus } from '@prisma/client';
...
async function main() {
  ...
  console.log(`✅ Demo Project & Milestones created: ${project.title}`);
