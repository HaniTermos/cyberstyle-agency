...
export default function AdminGeoPage() {
  ...
  return (
    <div className="space-y-8 font-sans pb-12">
      ...
      {/* Honesty & Observational Data Disclosure Banner */}
      <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-mono flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">Manual Observation / Experimental Metric — Not an Automated Live Feed</span>
        </div>
        <span className="text-[11px] text-zinc-400">
          AI recommendation observations reflect periodic manual test prompts. AI engine outputs vary dynamically and cannot be guaranteed or cited under an SLA.
        </span>
      </div>
