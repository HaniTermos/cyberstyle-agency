      ...
      <section className="py-24 px-6 bg-[#08090C]">
        <div className="max-w-7xl mx-auto space-y-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <Card variant="light" className="p-8 flex flex-col justify-between bg-white border border-black/10 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="pt-16 border-t border-white/10 space-y-8">
            <div className="max-w-2xl">
              <span className="text-xs font-mono uppercase tracking-widest text-[#00F0FF] mb-2 block">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {VALUE_EXTRAS.map((extra, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-white/[0.03] border border-white/10 space-y-2">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#00F0FF] shrink-0" />
                    <h4 className="font-display font-bold text-base text-white">{extra.title}</h4>
                  </div>
          ...
          <div className="p-8 rounded-2xl bg-white/[0.03] border border-white/10 space-y-6 max-w-4xl mx-auto text-sm text-neutral-300">
